...
% 设置默认字体大小和字体名称 
set(groot, 'DefaultAxesFontSize', 12, 'DefaultAxesFontName', 'Arial'); % 设置默认的图形背景颜色和图例框 
set(groot, 'DefaultFigureColor', 'w'); 
% 设置默认颜色顺序（例如，使用更易于区分的颜色） 
set(groot, 'DefaultAxesColorOrder', [0 0 1; 1 0 0; 0 1 0; 1 0 1]); 
% 设置默认的坐标轴线宽 
